 ...
 * @generated
 */
public class ProcessTest extends NamedElementTest {
	 ...
	 */
	@Override
	protected San.Process getFixture() {
		return (San.Process)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(SanFactory.eINSTANCE.createProcess());
	}
