...
public class SanSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SanPackage.MEASURAND: {
				Measurand measurand = (Measurand)theEObject;
				T result = caseMeasurand(measurand);
				if (result == null) result = caseNamedElement(measurand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SanPackage.BINDING: {
			...
			case SanPackage.PROCESS: {
				San.Process process = (San.Process)theEObject;
				T result = caseProcess(process);
				if (result == null) result = caseNamedElement(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SanPackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SanPackage.EVENT: {
			...
			case SanPackage.TASK: {
				Task task = (Task)theEObject;
				T result = caseTask(task);
				if (result == null) result = caseTrigger(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SanPackage.THING: {
				Thing thing = (Thing)theEObject;
				T result = caseThing(thing);
				if (result == null) result = caseTrigger(thing);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseProcess(San.Process object) {
		return null;
	}
