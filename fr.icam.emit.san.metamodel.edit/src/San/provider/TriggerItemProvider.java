...
/**
 * This is the item provider adapter for a {@link San.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trigger_process_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trigger_process_feature", "_UI_Trigger_type"),
				 SanPackage.Literals.TRIGGER__PROCESS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SanPackage.Literals.TRIGGER__ARGUMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Trigger.class)) {
			case SanPackage.TRIGGER__ARGUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SanPackage.Literals.TRIGGER__ARGUMENTS,
				 SanFactory.eINSTANCE.createArgument()));
	}
