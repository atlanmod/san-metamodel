...
/**
 * This is the item provider adapter for a {@link San.Device} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_instrument_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_instrument_feature", "_UI_Device_type"),
				 SanPackage.Literals.DEVICE__INSTRUMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SanPackage.Literals.DEVICE__ARGUMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SanPackage.Literals.DEVICE__ARGUMENTS,
