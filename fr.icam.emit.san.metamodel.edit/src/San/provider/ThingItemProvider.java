...
/**
 * This is the item provider adapter for a {@link San.Thing} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThingItemProvider extends TriggerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thing_instrument_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thing_instrument_feature", "_UI_Thing_type"),
				 SanPackage.Literals.THING__INSTRUMENT,
				 true,
				 false,
				 true,
				 null,
