...
/**
 * This is the item provider adapter for a {@link San.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends TriggerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_binding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_binding_feature", "_UI_Event_type"),
				 SanPackage.Literals.EVENT__BINDING,
				 true,
				 false,
				 true,
				 null,
